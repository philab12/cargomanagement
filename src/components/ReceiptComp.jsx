...
const InvoiceComp = () => {
   ...
   const track_rep = JSON.parse(localStorage.getItem("track_receipt"))
        ...
        <div className="max-w-4xl mb-10">
            <header className='w-full'>
                ...
                <div className="invoiceTop">
                    <h1 className='text-center'>RECEIPT <span>{track_rep.receipt_number}</span></h1>{/*Invoice number goes into the span*/}
                </div>
            </header>
            <header className='text-xs flex justify-between flex-row-reverse'>
                ...
                <div>
                    ...
                    <div><small className='font-bold text-gray-500 mr-2'>DATE</small>{track_rep.trans_date}</div>
