...
import SecurityQuestionList from "../features/securityQuestion/SecurityQuestionList"
import SecurityQuestionModal from '../modals/SecurityQuestionModal'
    ...
    return (
        ...
        <div className='my-5 p-5 bg-white rounded-md'>
            <section className='flex justify-between'>
                <h1 className=''>Security Questions</h1>
