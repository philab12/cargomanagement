...
import CollectedCourierList from "../features/transaction/CollectedCourierList"
import CollectedCourierModal from '../modals/CollectedCourierModal'


function CollectedCourierPage(props) {
        ...
        <> 
                        ...
                        <div className='my-5 p-5 bg-white rounded-md'>
                            <section className='flex justify-between'>
                                ...
                                <CollectedCourierModal />
                            </section>
                        </div>
                        <div className='contentTable w-full'>
                            <CollectedCourierList />
                        </div>
...
export default CollectedCourierPage