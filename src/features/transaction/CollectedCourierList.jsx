...
// const URL = "/transaction-detail/received";

function CollectedCourierList() {
   ...
   // console.log(branch_id)
    ...
    const data = dataa.filter(trans => trans.courier_stage === "COLLECTED" && trans.receive_branch_id === branch_id)
 

    //RECEIVECOURIERMODAL
    const handleEdit = (id) => {
        if(selectPagee !== MODALNAMES.COLLECTEDCOURIERMODAL){
    
            dispatch(setActionPage({isEdit:true, page:MODALNAMES.COLLECTEDCOURIERMODAL, id}))
...
//                  refetch();
//                  successNotification("This Receive Courier Deleted Successfully");
//                  }
//             }catch(error){

//                 errorNotification("This Receive Courier Could Not Be Deleted")
...
export default CollectedCourierList