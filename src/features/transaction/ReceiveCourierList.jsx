...
function ReceiveCourierList() {
    ...
    const data = dataa.filter(trans => trans.courier_stage === "RECEIVED" && trans.receive_branch_id === branch_id)
    ...
    const handleEdit = (id) => {
        if(selectPagee !== MODALNAMES.RECEIVECOURIERMODAL){
            ...
            dispatch(setActionPage({isEdit:true, page:MODALNAMES.RECEIVECOURIERMODAL, id}))
...
export default ReceiveCourierList