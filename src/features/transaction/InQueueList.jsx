...
function InQueueList() {
    ...
    const data = dataa.filter(trans => trans.courier_stage === "IN QUEUE" && trans.payment_status !== PAYMENT_STATUS.PENDING && trans.branch_id === branch_id)
...
const columns = [
...

    {
        ...
        valueGetter: (params) => {
          // console.log(params.row.transaction_detail.receiver_branch.branch)
            return `${params.row.receiver_branch.branch} ${params.row.receiver_branch.branch}`
